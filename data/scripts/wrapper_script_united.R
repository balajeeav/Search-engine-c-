...
for (i in 1:author_num)
{
  ...
  lapply("Publications (Google): ", write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  lapply(num, write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  lapply("Publications (Microsoft): ", write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  lapply(num_micro, write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  
  lapply("Years in science (Google): ", write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  lapply(years_in_science, write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  lapply("Years in science (Microsoft): ", write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  lapply(years_in_science_micro, write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  
  lapply("Hirsch index (Google): ", write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  lapply(h_res, write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  
  lapply("Hirsch index (Microsoft): ", write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  lapply(h_res_micro, write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  
  lapply("Citations (Google): ", write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  if (num>0)
  {
    lapply(t(citations), write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  }
  if (num==0)
  {
  ...
  lapply("Citations (Microsoft): ", write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  if (num>0)
  {
    lapply(t(citations_micro), write, "/home/alexandr/Object_search/output.txt", append=TRUE)
  }
  if (num==0)
  {
    lapply('-', write, "/home/alexandr/Object_search/output.txt", append=TRUE)
